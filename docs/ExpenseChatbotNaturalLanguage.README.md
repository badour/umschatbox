...
2. آخر 3 سنوات.
3. رقم حساب مثل `3314`.
4. اسم حساب مثل `شمس المحبة`.
5. وصف حساب مثل `المصاريف المستحقة`.
6. اسم شخص.
7. كل السنوات أو حسب السنوات.
...
حتى يعرف SQL أنه يجب التجميع حسب السنة الدراسية من 1 أيلول إلى 31 آب.
